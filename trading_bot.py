...
# ========== CONFIG ==========
# 🎯 हार्डकोडेड Alchemy API key (सुरक्षा के लिए आप इसे बाद में Environment Variable में डाल सकते हैं)
...
# ========== सभी एड्रेस checksum स्वरूप में ==========
CONTRACT_ADDRESS = Web3.to_checksum_address("0xBd6FB986340404B8068Fd14F70662366E3c87999")
...
SUSHISWAP_ROUTER = Web3.to_checksum_address("0x1b02dA8Cb0d097e645729F65f33A788624121522")
...
# ========== Web3 कनेक्शन – बाद में थ्रेड में इनिशियलाइज़ होगा ==========
w3 = None
account = None
contract = None
...
# ========== DefiLlama से मूल्य प्राप्त करें ==========
def get_defi_prices():
    url = (
        "https://coins.llama.fi/prices/current/"
        f"polygon:{USDC_ADDRESS},polygon:{WPOL_ADDRESS}"
    )
    try:
        ...
        with urllib.request.urlopen(req, timeout=12) as response:
            ...
            usdc_key = f"polygon:{USDC_ADDRESS}"
            wpol_key = f"polygon:{WPOL_ADDRESS}"
...
# ========== ARBITRAGE SCANNER (बैकग्राउंड थ्रेड) ==========
def arbitrage_scanner():
    init_web3()   # Web3 को थ्रेड में इनिशियलाइज़ करें
...
if __name__ == "__main__":
    # पहले Flask सर्वर शुरू करें, फिर बैकग्राउंड थ्रेड
